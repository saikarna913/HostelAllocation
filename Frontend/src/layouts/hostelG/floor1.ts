...
const floor1: AbsoluteFloorLayout = {
  ...
  nodes: [
    ...
    { id: '217', type: 'room', x: 308, y: 20, width: 60, height: 60 },
    { id: '215', type: 'room', x: 243, y: 20, width: 60, height: 60 },
    { id: '208', type: 'room', x: 183, y: 274, width: 60, height: 60 },
    { id: '210', type: 'room', x: 83, y: 274, width: 60, height: 60 },
    { id: '204', type: 'room', x: 356, y: 274, width: 60, height: 60 },
    { id: '218', type: 'room', x: 455, y: 182, width: 60, height: 60 },
    { id: '206', type: 'room', x: 248, y: 274, width: 60, height: 60 },
    { id: '211', type: 'room', x: 154, y: 378, width: 60, height: 60 },
    { id: '213', type: 'room', x: 89, y: 378, width: 60, height: 60 },
    { id: '207', type: 'room', x: 284, y: 377, width: 60, height: 60 },
    { id: '205', type: 'room', x: 349, y: 378, width: 60, height: 60 },
    { id: 'Wahroom', type: 'pantry', x: 427, y: 378, width: 88, height: 59, label: 'Wahroom' },
    { id: '209', type: 'room', x: 219, y: 378, width: 60, height: 60 },
    { id: '216', type: 'room', x: 308, y: 110, width: 60, height: 60 },
    { id: 'lift', type: 'pantry', x: 455, y: 146, width: 60, height: 24, label: 'lift' },
    { id: '214', type: 'room', x: 243, y: 110, width: 60, height: 60 },
